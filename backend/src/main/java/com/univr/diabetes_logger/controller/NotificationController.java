...
public class NotificationController {
    ...
    @GetMapping
    public Iterable<Notification> getAllNotifications() {return notificationService.getAll();}
    ...
    public ResponseEntity<Notification> createUserNotification(@RequestBody Notification notification, @PathVariable Integer userId,
