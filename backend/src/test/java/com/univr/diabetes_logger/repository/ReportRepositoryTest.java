...
public class ReportRepositoryTest {
  ...
  public void createReportTest() {
    ...
    User medicUser = userRepository.save(new User("medicmail", "pass", User.Role.MEDIC, true));

    Medic medic = medicRepository.save(new Medic(medicUser, "TestMedic", "lastname"));

    Patient patient = patientRepository.save(new Patient(patientUser, "TestFirstName", "TestLastName", LocalDate.of(2000, 1, 1), medic));

    Report report = new Report(120, true, "None", "None", LocalDateTime.now(), "Insuline", 3., patient);
