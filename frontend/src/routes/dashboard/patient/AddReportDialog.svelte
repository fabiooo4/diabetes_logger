              ...
              <input type="hidden" name="beforeMeal" value={beforeMeal} />
                ...
                bind:checked={beforeMeal}
						...
						<div class="relative w-full">
							<textarea
								id="symptoms"
								class="resize-none h-[6rem] rounded-card-sm border-border-input bg-background placeholder:text-foreground-alt/50 hover:border-dark-40 focus:ring-foreground focus:ring-offset-background inline-flex w-full items-center border px-4 py-4 text-base focus:ring-2 focus:ring-offset-2 focus:outline-hidden sm:text-sm"
